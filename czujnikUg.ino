...
void loop() {
  ...
  //  WskazujacyG = Wire.read();
  //  WskazujacyN = Wire.read();
  //  SrodkowyG = Wire.read();
  //  SrodkowyN = Wire.read();
  //
 ...
 val[4] = analogRead(A4); delay(1); val[5] = analogRead(A5);delay(1);
  ...
  Serial.println("        ");
 //Serial.print(val[0]); Serial.print("        "); Serial.println(val[1]);
  //Serial.print("SN:= "); Serial.println(val[0]); Serial.print("  "); Serial.println(war);
  delay(1000);
}
